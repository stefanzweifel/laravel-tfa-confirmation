...
Route::middleware(['web', 'auth'])
    ->group(function () {
        ...
        Route::get('/auth/two-factor-authentication/confirm', config('tfa-confirmation.challenge_controller'))
        ...
        Route::post('/auth/two-factor-authentication/confirm', config('tfa-confirmation.confirmation_controller'))
